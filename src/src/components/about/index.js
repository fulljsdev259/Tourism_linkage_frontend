    ...
    return <div className="about">
        ...
        <div className="content">
            ...
            <p>
                ...
                As priority policy, the Ministry of Tourism has targeted the development and strengthening of sustainable linkages between the tourism sector and other productive sectors of the economy such as agriculture, manufacturing and entertainment — to which it is closely linked. The Tourism Linkages Network which was approved by Cabinet decision and established in June 2013 to fulfill the ministry’s mandate to create and sustain linkages throughout productive industries. The Tourism Linkages Network is a department of the Tourism Enhancement Fund.
            </p>
            <div className="heading">Objectives</div>
            <p>
                The primary objective of the Tourism Linkages Network is to increase the consumption of goods and services that can be competitively sourced locally. It also aims to create employment while generating and retaining the country’s foreign exchange earning potential.            </p>
