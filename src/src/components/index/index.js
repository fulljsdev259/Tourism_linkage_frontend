...
const sliderImages = [{
    url: slider1,
    title: "Connecting suppliers and buyers.",
}, {
    url: slider2,
...
{
    url: slider6,
    title: "fostering community pride.",
},
{
    url: slider3,
    title: "creating demand for jobs",
}, {
    url: slider4,
    title: "building valuable resources",
}, {
    url: slider5,
    title: "local businesses thrives, everyone wins ",
},
    ...
    render() {
        ...
        return <div>
            <div className="home">
                ...
                <div className="divMiddleMobileOnly">
